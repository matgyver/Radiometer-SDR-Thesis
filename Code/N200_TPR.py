...
# Generated: Sat Mar 16 20:14:21 2013
##################################################
...
class N200_TPR(grc_wxgui.top_block_gui):
	...
	def __init__(self, dcg=1, devid="addr=192.168.10.2", srate=10.0e6, spa=1, rxant="", tpint=2.0, rfgain=0.0, frequency=1.406e9, decln=-28.0, subdev="A:0", maxg=50, fftsize=8192, clock=100.0e6):
		...
		self.gr_single_pole_iir_filter_xx_0 = gr.single_pole_iir_filter_ff(1.0/((samp_rate*integ)/2.0), 1)
		...
		self.connect((self.blks2_logpwrfft_x_0, 0), (self.gr_keep_one_in_n_1, 0))
	...
	def set_samp_rate(self, samp_rate):
		...
		self.set_fftrate(int(self.samp_rate/self.fftsize))
		self.gr_single_pole_iir_filter_xx_0.set_taps(1.0/((self.samp_rate*self.integ)/2.0))
	...
	def set_spavg(self, spavg):
		...
		self.blks2_logpwrfft_x_0.set_avg_alpha(1.0/float(self.spavg*self.fftrate))
