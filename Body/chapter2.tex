...
The difference however lays with how power information is extracted from the signal.  The original ISU radiometer purposefully under-sampled the signal but is still able to extract power information, however at the cost of losing frequency information.  
