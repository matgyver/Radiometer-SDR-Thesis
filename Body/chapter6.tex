...
\begin{figure}[h!tb] \centering
\includegraphics[width=\textwidth]{Experiments/Exp5/rqvsbw.pdf}
\isucaption{Graph of the total power measured versus the bandwidth of the measured signal.}
\label{power_bw}
\end{figure}
