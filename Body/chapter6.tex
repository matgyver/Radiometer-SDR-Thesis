...
\isucaption{Screenshot of the waterfall display showing the magnitude of the recieved power as a color, the frequency on the y-axis and time on the x-axis.}
\label{LN2_waterfall}
\end{figure}
...
\isucaption{Side by side comparison of the waterfall display for when the matched load is submerged in LN2 and ice water.}
