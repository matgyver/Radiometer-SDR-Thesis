...
The voltage from a radiometer can be expressed as the sum of the noise voltages which the amplitude distribution of which is nearly Gaussian as defined by the central limit theorem.  This results in a voltage mean of zero, but results in the root mean square (rms) value of the voltage to be greater than zero in a band limited sample.
