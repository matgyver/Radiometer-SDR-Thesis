...
As it can be seen in figure \ref{Stability}, the amount of change over a period of one hour is quite small.  A change in rQ of .002 is observed with a standard deviation of $7.6 x 10^-6$.  This equates to roughly a change of .6 kelvin and is well within our desired change of less than 1 kelvin for our radiometer.
