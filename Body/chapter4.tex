...
\includegraphics[width=\textwidth]{Images/20140810_150110.jpg}
...
\isucaption{Image of the being filtered out by the SDR.  It can be seen that the signal is no longer visible.}
\label{filter_on}
\end{figure}
