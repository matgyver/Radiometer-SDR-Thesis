...
%Because we have the in-phase signal (I) and the quadrature phase (Q), which is the signal shifted ninety degrees (i.e. $\phi + 90^{\circ}$) of the signal, 
...
\isucaption{Power measurements from a square law detector before integration or filtering}
\label{square_raw}
\end{figure}
}
