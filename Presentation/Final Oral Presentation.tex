...
\begin{frame}
\frametitle{Implementation of Square-law detector}
...
\begin{frame}
\frametitle{IIR as an integrator}
...
\begin{frame}
\frametitle{Basic GNURadio Blocks}
\begin{block}{GRC}
...
\subsection{Liquid Nitrogen Test setup}

\subsection{Results from LN2 Test}
...
\note[item]{Fix issues with SWR and interference}
\item Make improvements to the support HW for the ISU Radiometer
\note[item]{Replacing the Rabbit uC with PIC32}
\item Correlation
