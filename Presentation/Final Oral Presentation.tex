...
\title[SDR Radiometer]{Implentation of a Total Power Radiometer in Software Defined Radios} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Matthew E. Nelson} % Your name
...
\begin{frame}
Additional text for introduction
\end{frame}
