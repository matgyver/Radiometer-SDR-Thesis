...
The goal of this thesis is to explore a low cost method for implementing a total power radiometer using software defined radio and to demonstrate the effectiveness of this system.
\end{block}
\pause
...
\begin{block}{SDR Radiometer}
A software defined radio captures both phase and magnitude of the signal.  This information allows us to recreate the signal and manipulate the signal any way we wish.  This allows for more in-depth analysis of the signal and gives us the ability to detect things, such as an interfering signal, that might otherwise be missed with a traditional radiometer.
\end{block}
\end{frame}
%---------------------------------
